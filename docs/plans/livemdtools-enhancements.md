...
- localStorage: `livemdtools-theme` = `light|dark|auto`
...
**Usage:**
```bash
livemdtools validate examples/counter
...
**Changes:**
- Created `cmd/livemdtools/commands/validate.go` with ValidateCommand implementation
...
**Usage:**
```bash
livemdtools blocks examples/counter
...
**With verbose mode:**
```bash
livemdtools blocks examples/counter --verbose
...
**Implementation:**
- Write markdown docs
- Host as livemdtools tutorial (dogfooding!)
- Add search
...
- ✅ Scaffold generator - `livemdtools new` (A5) - COMPLETED
- ✅ Block inspector - `livemdtools blocks` (A6) - COMPLETED
...
site:
  ...
  repository: https://github.com/livetemplate/livemdtools
