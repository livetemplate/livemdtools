...
> Build a contact form with LivePage. Include name, email, subject, message, and a newsletter checkbox. Show submitted contacts in a table with delete buttons. Use form validation. Use semantic HTML.
