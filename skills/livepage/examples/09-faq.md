...
> Build an FAQ page with LivePage. Use HTML details/summary for collapsible Q&A sections. Include a hidden admin form to add new FAQs with question, answer, and category. Show category badges. Include delete buttons. Use semantic HTML.
