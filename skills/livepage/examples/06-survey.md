...
> Build a customer survey with LivePage. Include name, email, satisfaction rating (radio buttons), how they heard about us (dropdown), a 1-10 rating slider, comments textarea, and a "would recommend" checkbox. Show results in cards. Use semantic HTML.
