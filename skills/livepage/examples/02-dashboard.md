...
1. **Source configuration** - `livepage.yaml` defines the REST API endpoint
...
> Build a user dashboard with LivePage that fetches data from JSONPlaceholder API. Show a table with ID, name, email, and company. Add stat cards showing total users. Include a refresh button. Use semantic HTML.
