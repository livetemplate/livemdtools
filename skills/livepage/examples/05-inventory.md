...
1. **PostgreSQL source** - Define query in `livepage.yaml`, reference with `lvt-source`
...
> Build an inventory manager with LivePage. Connect to PostgreSQL for products. Show a table with name, SKU, quantity, price. Highlight low stock (under 10). Include add/delete functionality. Use semantic HTML.
