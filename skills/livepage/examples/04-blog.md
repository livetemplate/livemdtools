...
> Build a simple blog with LivePage. Let users write posts with a title, content, and optional author name. Display posts in a card layout with timestamps. Include delete buttons. Use semantic HTML.
